...
describe('Avatar Integration', () => {
  ...
  describe('Image Data', () => {
    ...
    it('Should set the Avatar Face', async () => {
      expect(await avatar_0.faceAddress()).to.equal('0x0000000000000000000000000000000000000000')
      
      await avatar_0.setFace(avatarFace.address, 0)
      
      expect(await avatar_0.faceAddress()).to.equal(avatarFace.address)
    })
